<template lang="jade">
  #apcsp-landing
    ...
    h3 CodeCombat’s curriculum features:
    ul
      li Free, self-paced professional development with guidance from our in-house educational experts
    ...
    p CodeCombat’s course can be used to learn programming in either JavaScript or Python, which teachers will choose upon creation of their classroom inside the CodeCombat platform.
  
    h5 Teacher Verification
    p Teachers who apply for and are approved through CodeCombat’s verification process will be given access to our full AP® Computer Science Principles curriculum, including all professional development and assessment materials. The verification process does not cost teachers anything, but is designed to maximize our professional development efforts.
